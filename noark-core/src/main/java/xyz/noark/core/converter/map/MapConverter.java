 ...
 * @since 3.4.8
 */
@TemplateConverter(Map.class)
public class MapConverter extends AbstractMapConverter implements Converter<Map<Object, Object>> {
    ...
    public Map<Object, Object> convert(Field field, String value) throws Exception {
        return Collections.unmodifiableMap(super.convert(field, value));
    }

    @Override
    public Map<Object, Object> convert(Parameter parameter, String value) throws Exception {
        return Collections.unmodifiableMap(super.convert(parameter, value));
    }

    @Override
    public Map<Object, Object> convert(Field field, Map<String, String> data) throws Exception {
        return Collections.unmodifiableMap(super.convert(field, data));
    }
