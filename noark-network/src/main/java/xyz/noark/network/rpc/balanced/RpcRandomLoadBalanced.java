 ...
 * @since 3.4.7
 */
public class RpcRandomLoadBalanced extends AbstractLoadBalanced implements RpcLoadBalanced {
    private final List<RpcConnector> connectorList;

    public RpcRandomLoadBalanced(List<RpcConnector> connectorList) {
    ...
    protected synchronized RpcConnector doTake() {
        return RandomUtils.randomList(connectorList);
    }
}
