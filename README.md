...
Gradle
```
implementation "xyz.noark:noark-game:3.4.5.Final"
```
当前需要Jdk1.8，Noark版本最新已是3.4.5了
...
2018-08-16 18:23:38.609 [main] INFO AbstractServerBootstrap.java:166 - :: Noark :: 3.4.5.Final
