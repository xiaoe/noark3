...
class UnrealizedAdaptor extends AbstractValueAdaptor<Void> {
    ...
    @Override
    public void parameterToPreparedStatement(EntityMapping<?> em, FieldMapping fm, PreparedStatementProxy pstmt, Object entity, int index) {
        throw new UnrealizedException("未实现的数据存储类型:" + fm.getType());
    }
