...
public class SkillTemplate {
    ...
    /** 释放类型参数1 */
    @TplAttr(name = "CastAttr0")
    private int castAttr_0;
    /** 释放类型参数2 */
    @TplAttr(name = "CastAttr1")
    private int castAttr_1;
    /** 释放类型参数3 */
    @TplAttr(name = "CastAttr2")
    private int castAttr_2;
    /** 最大充能层数 */
    ...
    public int getCastAttr_0() {
        return castAttr_0;
    }

    public int getCastAttr_1() {
        return castAttr_1;
    }

    public int getCastAttr_2() {
        return castAttr_2;
    }
